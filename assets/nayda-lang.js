/* Avare Biotech — единый переключатель языков для Nayda (server-side перевод).
   Подключается на всех страницах. Точка вставки — элемент с классом nayda-lang.
   Если у элемента задан атрибут data-ar с URL ручной страницы — арабский открывает её; иначе арабский переводит Nayda.
   Язык берётся из html lang, который проставляет Nayda. Навигация — реальные переходы на префикс языка. */
(function () {
